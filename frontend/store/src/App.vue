  ...
  <main class="app-shell">
    ...
    <template v-else-if="product">
      ...
      <div class="pd-mobilebar">
        <div class="pd-mobilebar__price"><span>Total</span><strong>{{ rupiah.format(orderTotal) }}</strong></div>
        <a class="pd-mobilebar__icon" :href="waLink" target="_blank" rel="noopener" aria-label="Tanyakan Produk">
        ...
        <button class="pd-mobilebar__cart" type="button" :disabled="addingToCart || uploading" @click="addCart">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="9" cy="20" r="1.4"/><circle cx="18" cy="20" r="1.4"/><path d="M2 3h2.2l2.4 12.2a2 2 0 0 0 2 1.6h8.9a2 2 0 0 0 2-1.6L21 7H5"/></svg>
          <span>{{ addingToCart || uploading ? '…' : 'Tambah' }}</span>
        </button>
      </div>
